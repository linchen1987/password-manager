...
#[tauri::command]
pub fn encrypt_message(message: String, password: String) -> Result<String, String> {
...
#[tauri::command]
pub fn decrypt_message(encrypted_data: String, password: String) -> Result<String, String> {
